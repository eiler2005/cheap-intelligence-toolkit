<!-- Canonical version, kept up to date: https://cheap-intelligence.vercel.app/en/playbooks/personal-harness-builder
...
> Use this after the [Task-to-Outcome Map](task-to-outcome-map.md), once you know which tasks you are analyzing.
...
> Faster in your browser: Use the [Personal Harness Builder](https://cheap-intelligence.vercel.app/en/skills/personal-harness-builder/) to score all seven layers and find the weak link and your next move.
...
- After a task repeats three times, do I turn it into a template, checklist, or `skill`?
- Do my skills set boundaries where AI must stop and ask a human?
